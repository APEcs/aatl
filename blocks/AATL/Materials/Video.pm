...
package AATL::Materials::Video;

use strict;
use base qw(AATL::Materials);

use AATL::System::Materials;
use AATL::System::Materials::Video;
...
# @return A new instance of the AATL::Video class on success, undef otherwise
sub new
{
    my $invocant = shift;
    ...
    $self -> {"materials::video"} = AATL::System::Materials::Video -> new(dbh => $self -> {"dbh"},
        ...
        or return Webperl::SystemModule::set_error("Video initialisation failed: ".$AATL::System::Materials::Video::errstr);
